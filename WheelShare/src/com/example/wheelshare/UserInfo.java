...
public class UserInfo implements Parcelable {
	...
	private Integer successfulRides;
	private List<AdInfo> adInfo;

	// constructor
	public UserInfo(String userName, String firstName, String lastName,
			String gender, List<AdInfo> adInfo, Integer totalRides,
			Integer successfulRides, String creditCardNum) {
	...
	public UserInfo(String userName, String firstName, String lastName,
			String gender, Integer totalRides, Integer successfulRides,
	...
	public void setTotalRides(Integer total) {
		totalRides = total;
	}

	public void setSuccessfulRides(Integer total) {
	...
	public Integer getSuccessfulRides() {
