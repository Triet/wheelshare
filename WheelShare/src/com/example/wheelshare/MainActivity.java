...
public class MainActivity extends Activity {
	...
	static TextView loginErrorMsg,text;
	static private Context context;
	static private Activity mainActivity;
	public static boolean hindi=false;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		HindiButtonListener();						// activity_home once the user logs in
	...
	public void HindiButtonListener() {
